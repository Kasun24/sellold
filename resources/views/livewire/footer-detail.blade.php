<section class="footer-section">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="footer-widget about-widget">
					...
					<ul>
						...
						<li><a href="https://track24.net/" target="_blank">Track Orders</a></li>
	...
	<div class="social-links-warp">
		<div class="container">
			...
			@endif
			<p class="text-white text-center mt-5">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Developed By <a href="https://github.com/Kasun24" target="_blank">Kasun Sampath</a></p>
