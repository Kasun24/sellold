	...
	<section class="contact-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=ati%20gampaha&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe><br />
				</div>
			</div>
		</div>
		{{-- <div class="map">
